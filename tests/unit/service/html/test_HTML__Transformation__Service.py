...
class test_HTML__Transformation__Service(TestCase):
    ...
    def test__fast_api__servers(self):                                              # Verify both servers running
        ...
        with HTML__Transformation__Service().setup() as _:
    ...
    def test_setup(self):                                                           # Test setup method with real services
        env_vars = {'AUTH__TARGET_SERVER__HTML_SERVICE__BASE_URL' : self.html_service_base_url,
                    'AUTH__TARGET_SERVER__CACHE_SERVICE__BASE_URL' : self.cache_service_base_url}
